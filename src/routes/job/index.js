...
const { jsonWebToken, jobValidator } = require('../../middleware');
const { urlConstants } = require('../../constants');
const upload = require('../../middleware/document_upload');

module.exports = (app) => {
    app.post(urlConstants.CREATE_JOB, jsonWebToken.validateToken, jobValidator.jobValidation, upload.single('files'), jobController.createJob);
