...
module.exports = (app) => {
    app.post(urlConstants.CREATE_JOB_PROPOSAL, jsonWebToken.validateToken, jobProfileValidator.jobProposalValidation, upload.array('files', 5), jobProposalController.createJobProposal);
